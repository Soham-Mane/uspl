        ...
        <div key={index} className="trade_container mb-1 border rounded bg-white p-2">
          <table className="w-full h-full">
            <tbody>
              ...
              <tr>
                {/* <td className="text-sm">{moment(trade.BUYTIME).format('DD MMM YYYY HH:mm')}</td>
                <td className="text-sm">&#8377; {trade.BUYPRICE.toFixed(2)}</td>
                <td className="text-sm">{trade.BUYVALUE.toFixed(2)}</td>
                <td className="flex justify-center text-green-500">BUY</td> */}
...
<td className="flex justify-center text-green-800 font-medium">BUY</td>
              ...
              <tr>
                ...
                {/* <td className="text-xl font-bold text-green-600">{trade["POINTS GAIN"] ? trade["POINTS GAIN"].toFixed(2) : 'N/A'}</td> */}
  ...
  {trade["POINTS GAIN"] ? trade["POINTS GAIN"].toFixed(2) : 'N/A'}
              ...
              <tr>
                ...
                {/* <td className="text-xl font-bold text-green-600">{trade["PROFIT/LOSS"] ? trade["PROFIT/LOSS"].toFixed(2) : 'N/A'}</td> */}
