...
>
  ...
  Back
        ...
        <h2 className="mb-12 text-6xl font-extrabold text-center italic text-black-600 leading-tight tracking-wide shadow-lg">
...
<input
            ...
            min="25000" // Assuming a minimum investment of 25,000
            max="5000000" // Assuming a maximum investment of 5,000,000
            className="appearance-none text-lg h-22 block w-1/4 px-3 py-2 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
          />

<div className="my-8 p-6 bg-white rounded-lg shadow-xl border-t-4 border-indigo-500">
